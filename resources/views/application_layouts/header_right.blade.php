...
<div class="container d-flex clearfix" id="b-accessibility">
    <div class="b-ministryname">
        ...
        <div class="d-inline-block font-weight-bold b-acc-ministry pl-sm-2">
            <span>Ministry name goes here</span>
        </div>
    </div>
...
<div class="container clearfix" id="b-header">
    ...
    <div class="float-left d-flex h-100">
        <h2 class="align-self-center pl-3 b-appname"><span class="font-weight-bold">Rajasthan Agriculture Land Allotment Management System</span> <br><span class="b-appfullname"> Tagline goes here</span></h2>
    </div>
</div>
        ...
        <nav class="navbar navbar-expand-sm navbar-dark px-0">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav main-menu d-flex">
                    ...
                    <li class="nav-item d-block"> <a href="inner.html" class="nav-link">Schemes</a></li>
                    <li class="nav-item d-block"> <a href="inner.html" class="nav-link">Major Crops</a></li>
