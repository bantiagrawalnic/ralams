        ...
        <nav class="navbar navbar-expand-sm navbar-dark px-0">
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav main-menu d-flex">
                    <li class="nav-item d-block"> <a href="{{ route('home')}}" class="nav-link active">Home</a> </li>
                    ...
                    @if(Auth::user())
                    <li class="nav-item d-block" style="text-align: right; width: 100%;"> <a href="{{route('logout')}}" class="nav-link">Logout ({{Auth::user()->name}})</a></li>                    
                    @endif
                </ul>
            </div>
