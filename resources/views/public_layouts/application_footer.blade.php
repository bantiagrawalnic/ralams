<div class="footer-bs">
    <footer class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-8 footer-social d-flex">
                <div class="d-inline-block align-self-center">
                    ...
                    <p class="bg-light"><img src="{{ asset('public_assets/images/NIC.png') }}" alt="NIC logo"></p>
                    <!-- <p class="bg-light mb-0"><img src="images/digital-india.png" alt="digital india logo"></p> -->
                    <p class="bg-light mb-0"><img src="{{ asset('public_assets/images/digital-india.png') }}" alt="digital india logo"></p>
                </div>
            </div>
        ...
        <div class="text-center mt-5 b-footer-credit" style="color: #000!important">
            This website belongs to Department of <a class="font-weight-bold" href="#">{{ __('labels.department_of_revenue_rajasthan') }}</a>, <a class="font-weight-bold" href="https://rajasthan.gov.in/">{{ __('labels.government_of_rajasthan') }}</a>
        </div>
    </footer>
</div>