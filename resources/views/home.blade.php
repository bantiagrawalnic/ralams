                                ...
                                <div class="table-responsive">
                                    <section class="card-container" style="margin-top:50px;">
                                        <div class="col-md-4 col-sm-6 col-12 MainBox">
                                            <a href="{{ route('get.all.application','pending')}}" title="" target="_blank">
                                                <div class="serviceBox purple">
                                                    <div class="service-icon pt-3">
                                                        <span><i class="fa fa-clock-o" aria-hidden="true"></i></span>
                                                    </div>
                                                    <h3 class="title">Total Pendings</h3>
                                                    <p class="description">
                                        ...
                                        <div class="col-md-4 col-sm-6 col-12 MainBox">
                                            <a href="{{ route('get.all.application','processing') }}" title="" target="_blank">
                                                <div class="serviceBox orange">
                                                    <div class="service-icon pt-3">
                                                        <span><i class="fa fa-spinner" aria-hidden="true"></i></span>
                                                    </div>
                                                    <h3 class="title">Total Processing</h3>
                                                    <p class="description">
                                        ...
                                        <div class="col-md-4 col-sm-6 col-12 MainBox">
                                            <a href="{{ route('get.all.application','completed') }}" title="" target="_blank">
                                                <div class="serviceBox blue">
                                                    <div class="service-icon pt-3">
                                                        <span><i class="fa fa-check" aria-hidden="true"></i></span>
                                                    </div>
                                                    <h3 class="title">Total Completed</h3>
                                                    <p class="description">
                                        ...
                                        <div class="col-md-4 col-sm-6 col-12 MainBox">
                                            <a href="{{ route('get.all.application','rejected')}}" title="" target="_blank">
                                                <div class="serviceBox pink">
                                                    <div class="service-icon pt-3">
                                                        <span><i class="fa fa-ban" aria-hidden="true"></i></span>
                                                    </div>
                                                    <h3 class="title">Total Rejected</h3>
                                                    <p class="description">
